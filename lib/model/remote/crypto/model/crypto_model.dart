class CryptoAssetsModel {
  ...
  factory CryptoAssetsModel.fromJson(Map<String, dynamic> json) => CryptoAssetsModel(
    ...
    dataQuoteStart: json["price_usd"] == null ? DateTime.now() : DateTime.parse(json["data_quote_start"]),
    dataQuoteEnd: json["price_usd"] == null ? DateTime.now() :DateTime.parse(json["data_quote_end"]),
    dataOrderbookStart: json["price_usd"] == null ? DateTime.now() :DateTime.parse(json["data_orderbook_start"]),
    dataOrderbookEnd: json["price_usd"] == null ? DateTime.now() :DateTime.parse(json["data_orderbook_end"]),
    dataTradeStart: json["price_usd"] == null ? DateTime.now() :DateTime.parse(json["data_trade_start"]),
    dataTradeEnd: json["price_usd"] == null ? DateTime.now() :DateTime.parse(json["data_trade_end"]),
    ...
    priceUsd: json["price_usd"] == null ? 1 : json["price_usd"].toDouble() ?? 1,
    idIcon: json["price_usd"] == null ? '' : json["id_icon"],
